...
if (QueryString.hasOwnProperty('cluster')) {
	...
	if (cluster !== false && (cluster > -1 && cluster < clusters.length)) {
		...
		var nouns_suffix = ['~ community', '~ communities', '~ org', '~ orgs', '~ organization', '~ organizations', '~ organizing', '~ organizer', '~ organizers', '~ community organizer', '~ community organizers', '~ community organizing', '~ nonprofit', '~ nonprofits', '~ non-profit', '~ non-profits', '~ non profit', '~ non profits', '~ nonprofit organization', '~ nonprofit organizations', '~ non-profit organization', '~ non-profit organizations', '~ non profit organization', '~ non profit organizations'];
		/*
  '~ leader',
  '~ leaders',
  '~ leadership',
  ...
  '~ voices'
		...
		var topics = ['~ law', '~ laws', '~ bill', '~ bills', '~ legislation'];
		/*
		var verbs_prefix = [
			'donate ~',
		  'donating ~',
		...
		var verbs_prefix = ['donate to ~', 'give to ~', 'give money to ~', 'support ~', 'volunteer with ~', 'volunteer for ~', 'take action for ~'];
		var IMM_prefix = ['new', 'recent'];
		var GEO_prefix = ['california ~', "california's ~", 'californian ~', 'san diego ~', "san diego's ~", 'san diegan ~', 'los angeles ~', 'american ~', 'u.s. ~', 'united states ~', 'usa ~'];
		var geo_suffix = ['~ in san diego', '~ in california', '~ in san diego ca', '~ in san diego california', '~ in us', '~ in u.s.', '~ in usa', '~ in united states', '~ in america'];
		var QUESTIONS = ['where are ~ from', 'where do ~ come from', 'where do ~ live', 'where in san diego do ~ live', 'where are san diego ~ from', 'where do san diego ~ live', 'what language do ~ speak', 'what language do ~ know', 'what religion are ~', 'what country are ~ from', '~ from what country', 'what country do ~ come from', '~ country', '~ language', '~ religion', '~ holiday', '~ holidays', '~ festival', '~ festivals', '~ culture', '~ cultures', '~ art', '~ artist', '~ artists', '~ music', '~ musician', '~ musicians', '~ language', '~ languages', '~ poetry', '~ poet', '~ poets'];
